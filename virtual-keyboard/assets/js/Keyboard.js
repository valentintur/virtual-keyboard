...
import language from './languages/index.js'; // { en, ru }
import Key from './Key.js';

const main = create('main', 'main',
  [create('h1', 'header', 'RSS Virtual Keyboard'),
    create('p', 'main__paragraph', 'Keyboard for Win. To switch language: Left Ctrl + Alt')]);
...
export default class Keyboard {
  ...
  init(langCode) {
    ...
    this.output = create('textarea', 'textarea', null, main,
